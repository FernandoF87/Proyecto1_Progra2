...
/**
 * Class used to sort the different sessions in the Jlist of the AdminView
 * classes.
 *
 * @version 28/06/2022
...
public class AdminSessionComparator implements Comparator<Session> {
     ...
     * @return an integer, <b>-1</b> if the first is less than the second,
     * <b>1</b> if the first is major than the second, <b>0</b> if both are
     * equals.
     */
    @Override
